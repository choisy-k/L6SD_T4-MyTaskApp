...
namespace MauiApp1.Database
{
    ...
    {
        private const string DbName = "MyTaskDatabase.db3";
        //The AppDataDirectory is kind of a wrapper API that gives device-specific directory structure
...
// using generic route to perform the operations
